...
public:
	...
	int calcul_Distance_POI_Courant_Et_Plus_Proche_Hotel_Et_Id_PPH(int num_Jour, vector<int>  vector_id_POI_Jour, int id_POI, float distance_POI_Actuel_Et_POI_Courant, float tps_Attente, Solution* solution);
